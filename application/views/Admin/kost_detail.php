...
<div class="main-content">
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="row">
			    <div class="col-md-12">
			        <div class="overview-wrap mb-3">
			            <h3 class="title-1 ml-2"><i class="fas fa-sm fa-eye"></i> Detail Kosan</h3>
			...
			<div class="col-md-12">
			  <img src="<?= base_url(). 'assets/uploads/kost/'.$dt->gambar ?>" class="img-fluid rounded float-right" alt="..." style="width: 35rem; height: 30rem; padding: 10px;">
			<div class="card mb-3">
			  <div class="card-body">
			   <table class="table table-borderless table-hover">
				  ...
				  <tbody>
				    ...
				    <tr>
				     <td>Status</td>
				      <td>:</td>
				      <td><?php echo ($dt->status_hunian == "Available") ? '<b class="text-success">Available</b>' : '<b class="text-danger">Sold out</b>'; ?></td>
				    </tr>
				     <tr>
				     <td>Deskripsi</td>
				      <td>:</td>
			    ...
			    <br>
			    <hr>
	            <?= anchor('admin/kost/edit_kost/'.$dt->id_hunian,'<div class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></div>') ?>
	            <?= anchor('admin/kost/hapus_kost/'.$dt->id_hunian,'<div class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></div>') ?>
			  </div>
			</div>
	    <?php } ?>
		</div>
